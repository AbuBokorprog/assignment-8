...
exports.createBorrowRecordSchema = zod_1.z.object({
    borrowDate: zod_1.z.preprocess((arg) => (typeof arg === 'string' ? new Date(arg) : arg), zod_1.z.date().optional()),
...
exports.updateBorrowRecordSchema = zod_1.z.object({
    borrowDate: zod_1.z.preprocess((arg) => (typeof arg === 'string' ? new Date(arg) : arg), zod_1.z.date().optional()),
    returnDate: zod_1.z.preprocess((arg) => (typeof arg === 'string' ? new Date(arg) : arg), zod_1.z.date().optional()),
